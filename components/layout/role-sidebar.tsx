...
const clientNav = [
  ...
  { name: "Reports", href: "/dashboard/client/reports", icon: BarChart3 },
  ...
  { name: "JHB Dashboard", href: "/dashboard/jamaica-house", icon: Flame },
  {
...
const accountantNav = [
  ...
  { name: "Messages", href: "/dashboard/accountant/messages", icon: MessageSquare },
  {
    name: "Settings",
